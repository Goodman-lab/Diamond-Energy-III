...
# Load the files
file_names = ['GeoMol_Diamond_OPLS4.csv', 'GeoMol_qm9_OPLS4.csv', 'GeoMol_drugs_OPLS4.csv']
dataframes = {}

# Load each file, sort by 'Molecule', and rename the 'Lowest OPLS4 Energy' column to the file name without '.csv'
for file in tqdm(file_names):
    ...
    # Rename the 'Lowest OPLS4 Energy' column
    df.rename(columns={'Lowest OPLS4 Energy': new_column_name}, inplace=True)
...
plt.title('Mean Lowest OPLS4 Energy for Each Method')
